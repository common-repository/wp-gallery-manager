...
<div style="width:100%">
   ...
   <a target="_blank" href="http://wordpress.org/extend/plugins/wp-gallery-manager/" class="xyz_star">Rate this plugins</a> -
...
if(typeof xyz_gallery_check_email == 'undefined')
{
function xyz_gallery_check_email(emailString)
{
...
if(typeof xyz_gallery_verify_lists == 'undefined')
{
function xyz_gallery_verify_lists(form)
{
...
if(typeof xyz_gallery_verify_fields == 'undefined')
{
function xyz_gallery_verify_fields()
{

    if(xyz_gallery_check_email(document.email_subscription.email.value) == false){
    alert("Please check whether the email is correct.");
    document.email_subscription.email.select();
    return false;
    }else if(xyz_gallery_verify_lists(document.email_subscription)==false){
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="hidden" name="listName" value="1,9,">

<input type="submit" id="submit_em" value="subscribe" name="Submit"  onclick="javascript: if(!xyz_gallery_verify_fields()) return false; " />
...
Our Plugins : 
	...
	<a target="_blank"	href="http://wordpress.org/extend/plugins/custom-field-manager/">Custom Field Manager</a>
